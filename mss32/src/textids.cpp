...
void readLobbyTextIds(const sol::table& table, TextIds::Lobby& value)
{
    ...
    value.link1= lobby.get_or("link1", std::string());
    value.link2 = lobby.get_or("link2", std::string());
    value.link3 = lobby.get_or("link3", std::string());
...
void readInterfTextIds(const sol::table& table, TextIds::Interf& value)
{
    ...
    value.sellAllItemsUnequipped = interf.value().get_or("sellAllItemsUnequipped", std::string());
